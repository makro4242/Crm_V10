...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"No data available in table",sInfo:"Listelenen _START_ ve _END_ arası _TOTAL_ kayıtta",sInfoEmpty:"Listelenen 0 ve 0 arası 0 kayıtta",
sInfoFiltered:"(filtered from _MAX_ total Kayıt)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Listelenen _MENU_ Kayıt",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Arama:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
